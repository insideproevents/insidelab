...
const features = [
  'PA, mixers, micrófonos & decks DJ',
  'Iluminación de escenario & control',
  'Truss, stands, cables & power',
];
...
const Equipment = () => {
  ...
  return (
    <section ref={sectionRef} id="equipment" className="section-pinned bg-navy-900 z-[70] min-h-screen">
      {/* Left Text Panel */}
      <div
        ref={panelRef}
      ...
      >
        <div className="px-[7vw]">
          ...
          <h2 className="animate-item font-display text-section text-white mb-6 leading-tight">
            Backline, iluminación & gear de producción.
          </h2>
          <p className="animate-item text-base text-white/70 leading-relaxed mb-8">
            Kits confiables, probados antes de cada load-in. Recogida o delivery— 
            adaptamos el rig a tu venue.
          </p>
          ...
          <div className="animate-item flex flex-wrap gap-4">
            <button className="inline-flex items-center gap-2 px-5 py-2.5 border border-white/30 text-white text-sm font-medium rounded-lg hover:border-white/60 transition-colors duration-300">
              <List size={16} /> Ver lista de equipos
            </button>
            <a
              href="#contact"
              onClick={(e) => {
            ...
            >
              Preguntar por paquetes <ArrowRight size={16} />
            </a>
          </div>
        </div>
      </div>
